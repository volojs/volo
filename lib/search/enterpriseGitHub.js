...
function searchEnterprise(query, options, callback, errback) {
    ...
    enterprise.search(query).then(function (data) {
        ...
        if (amdOverride) {
            ...
            //This uses V3 of the Enterprise API, so the repo results are
            //slightly different from the above V2 search API results.
            enterprise.repo(amdOverride).then(function (entry) {
                var item;
